...
use crate::errors::project_branding_error::ProjectBrandingError;
...
///
/// ```
/// # use ephact_domain::value_objects::ProjectDescription;
...
impl ProjectDescription {
    ...
    /// ```
    /// # use ephact_domain::value_objects::ProjectDescription;
    /// # use ephact_domain::errors::ProjectBrandingError;

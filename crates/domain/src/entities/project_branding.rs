use crate::value_objects::{ProjectDescription, ProjectEmblem, ProjectName, ProjectVersion};
...
///
/// ```
/// # use ephact_domain::entities::ProjectBranding;
/// # use ephact_domain::value_objects::{

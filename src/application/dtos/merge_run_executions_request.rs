...
impl MergeRunExecutionsRequest {
    ...
    pub fn new(executions: Vec<WorkflowExecution>, all_workflows: bool) -> Self {
        Self {
            executions,
            all_workflows,
        }
    ...
    /// Executions to merge, in the order they ran.
    pub fn executions(&self) -> &[WorkflowExecution] {
        &self.executions
    }

    /// Consumes the request and returns the executions.
    pub fn into_executions(self) -> Vec<WorkflowExecution> {
        self.executions
    }
